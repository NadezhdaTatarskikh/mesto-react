...
function Card({ card, onCardClick, onCardLike, onCardDelit }) {
  ...
  return (
    <li className="photo-grid__item">
      {isOwn && <button
        ...
        type="button"
        aria-label="Кнопка для Удаления" onClick={handleDeleteClick}
      ></button>}
      <img
      ...
      <div className="photo-grid__option">
        ...
        <div className="photo-grid__like-container">
          <button
            ...
            type="button"
            name="addLike"
            aria-label="Кнопка нравится" onClick={handleLikeClick}
          ></button>
